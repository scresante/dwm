...
const char *spcmd2[] = {"st", "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20", "-e", "ipython", "--quiet", NULL };
...
/* modifier                     key        function        argument */
  ...
  { MODKEY|ShiftMask, XK_q,          killclient,  {0} },
    { MODKEY|ShiftMask|ALT, XK_q,       spawn,      SHCMD("killall -9 dwm") },
  ...
  { MODKEY|ALT,  XK_F12,      spawn,      SHCMD("notify-send -u normal -t 1000 'mod alt f12'")},
  { ShiftMask|ALT,XK_F12,    spawn,      SHCMD("notify-send -u normal -t 1000 'alt shift f12'")},
