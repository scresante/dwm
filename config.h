...
static Key keys[] = {
	...
	{ MODKEY,			XK_y,		spawn,	SHCMD("firefox") },
    ...
    { MODKEY|ControlMask|ShiftMask,     XK_r,   spawn,  SHCMD("notify-send -t3000 ctrl sh mod r") },
    { MODKEY|ControlMask,               XK_r,   spawn,  SHCMD("notify-send -t3000 ctrl mod r") },

    { MODKEY,		XK_backslash,		spawn,		SHCMD("/home/shawn/.local/bin/dwm-rebuild") },
